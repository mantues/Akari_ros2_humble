...
class reset_allout_client(Node):

    def __init__(self):
        super().__init__("reset_allout_client_node")
        # create client
        self.cli = self.create_client(
            Trigger, "reset_allout_m5"
    ...
    def send_request(self):
        self.get_logger().info("M5Stack allout reset")
