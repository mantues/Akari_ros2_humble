...
#include "akari_msgs/srv/detail/trigger__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const akari_msgs::srv::Trigger_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<akari_msgs::srv::Trigger_Request *>(
    untyped_ros_message);
...
{
  return &akari_msgs::srv::typesupport_fastrtps_cpp::_Trigger_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const akari_msgs::srv::Trigger_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<akari_msgs::srv::Trigger_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &akari_msgs::srv::typesupport_fastrtps_cpp::_Trigger_Response__handle;
}
...
{
  return &akari_msgs::srv::typesupport_fastrtps_cpp::_Trigger__handle;
}
