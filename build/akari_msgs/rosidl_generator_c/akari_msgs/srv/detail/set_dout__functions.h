...
#ifndef AKARI_MSGS__SRV__DETAIL__SET_DOUT__FUNCTIONS_H_
#define AKARI_MSGS__SRV__DETAIL__SET_DOUT__FUNCTIONS_H_
...
/// Initialize srv/SetDout message.
/**
...
/// Create srv/SetDout message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * akari_msgs__srv__SetDout_Request__init().
...
/// Destroy srv/SetDout message.
/**
 * It calls
 * akari_msgs__srv__SetDout_Request__fini()
...
/// Check for srv/SetDout message equality.
/**
...
/// Initialize array of srv/SetDout messages.
/**
...
/// Finalize array of srv/SetDout messages.
/**
 * It calls
 * akari_msgs__srv__SetDout_Request__fini()
...
/// Create array of srv/SetDout messages.
/**
 * It allocates the memory for the array and calls
 * akari_msgs__srv__SetDout_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetDout messages.
/**
 * It calls
 * akari_msgs__srv__SetDout_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetDout message array equality.
/**
...
/// Copy an array of srv/SetDout messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * akari_msgs__srv__SetDout_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_akari_msgs
...
/**
 * It calls
 * akari_msgs__srv__SetDout_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_akari_msgs
...
/**
 * It allocates the memory for the array and calls
 * akari_msgs__srv__SetDout_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_akari_msgs
...
/**
 * It calls
 * akari_msgs__srv__SetDout_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // AKARI_MSGS__SRV__DETAIL__SET_DOUT__FUNCTIONS_H_
