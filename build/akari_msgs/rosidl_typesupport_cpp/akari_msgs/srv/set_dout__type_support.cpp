...
static const _SetDout_Request_type_support_symbol_names_t _SetDout_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, akari_msgs, srv, SetDout_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, akari_msgs, srv, SetDout_Request)),
  }
};
...
{
  return &::akari_msgs::srv::rosidl_typesupport_cpp::SetDout_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, akari_msgs, srv, SetDout_Request)() {
  return get_message_type_support_handle<akari_msgs::srv::SetDout_Request>();
}
...
static const _SetDout_Response_type_support_symbol_names_t _SetDout_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, akari_msgs, srv, SetDout_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, akari_msgs, srv, SetDout_Response)),
  }
};
...
{
  return &::akari_msgs::srv::rosidl_typesupport_cpp::SetDout_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, akari_msgs, srv, SetDout_Response)() {
  return get_message_type_support_handle<akari_msgs::srv::SetDout_Response>();
}
...
static const _SetDout_type_support_symbol_names_t _SetDout_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, akari_msgs, srv, SetDout)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, akari_msgs, srv, SetDout)),
  }
};
...
{
  return &::akari_msgs::srv::rosidl_typesupport_cpp::SetDout_service_type_support_handle;
}
